 ...
 *
 * Usage:
 *   NODE_OPTIONS="--import vendor/openclaw-observability-plugin/instrumentation/preload.mjs" openclaw gateway start
 *
...
const SERVICE_NAME = process.env.OTEL_SERVICE_NAME || "transpect-gateway";
