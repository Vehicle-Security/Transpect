...
ALLOWLIST_RELATIVE_PATHS = {
    "scripts/demo/sanitize_showcase_paths.py",
    "scripts/validate/check_portability.py",
    "scripts/validate/check_repo.py",
}
FORBIDDEN_PATTERNS = [
...
def _recommendations(matches: list[dict[str, Any]]) -> list[str]:
    ...
    return [
        ...
        "Run python scripts/demo/sanitize_showcase_paths.py before committing frozen showcase artifacts.",
    ]
