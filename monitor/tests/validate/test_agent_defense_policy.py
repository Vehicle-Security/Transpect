...
from guardrail.agent_defense.policy import (
    domain_matches,
    evaluate_policy,
    load_policy,
    resolve_policy_path,
...
class PolicyLoadTests(unittest.TestCase):
    ...
    def test_load_policy_returns_defaults_for_missing_file(self) -> None:
        with patch(
            "guardrail.agent_defense.policy.resolve_policy_path",
    ...
    def test_load_policy_falls_back_to_legacy_path(self) -> None:
        with patch(
            "guardrail.agent_defense.policy._read_json",
    ...
    def test_load_policy_fills_missing_defaults(self) -> None:
        ...
        with patch("guardrail.agent_defense.policy._read_json", return_value=partial), patch.object(
