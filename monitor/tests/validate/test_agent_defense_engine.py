...
from guardrail.agent_defense.engine import inspect_action
...
class EngineInspectActionTests(unittest.TestCase):
    ...
    def test_normalize_and_fallthrough_to_guard(self) -> None:
        ...
        with patch(
            "guardrail.agent_defense.engine.normalize_action",
            return_value={"actionType": "open_external_link", "url": "https://example.com", "sourceType": "external_website"},
        ), patch(
            "guardrail.agent_defense.engine.load_policy",
            return_value={"allow": [], "block": [], "confirm": []},
        ), patch(
            "guardrail.agent_defense.engine.detect_bypass_escalation",
            return_value=None,
        ), patch(
            "guardrail.agent_defense.engine.inspect_security_action",
    ...
    def test_policy_block_forces_immediate_block(self) -> None:
        ...
        with patch(
            ...
            "guardrail.agent_defense.engine.add_risk_event",
            return_value="risk-1",
        ), patch(
            "guardrail.agent_defense.engine.decide",
    ...
    def test_bypass_escalation_forces_block(self) -> None:
        ...
        with patch(
            ...
            "guardrail.agent_defense.engine.force_bypass_block",
