...
class FridaResolver:
    ...
    def resolve(self, self_attach_check: bool = False) -> FridaResolution:
        ...
        try:
            ...
            res.install_hint = "python3 -m pip install --upgrade frida frida-tools --user"
        ...
        if res.arch_mismatch:
            res.install_hint = (
                ...
                "/opt/homebrew/bin/python3 -m venv .venv-frida-arm64 && "
                ". .venv-frida-arm64/bin/activate && "
                "python -m pip install --upgrade pip frida frida-tools"
            )
