...
sys.path.insert(0, str(REPO_ROOT / "scripts" / "diagnosis"))
    ...
    def test_sanitize_showcase_paths_rewrites_local_paths(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            artifact.write_text(
                json.dumps(
                    {
                        "path": "/Users/qwer/Documents/code/Transpect/live/runs/run-1",
                        "home": "/Users/qwer/.openclaw/session",
                        "python": "/opt/anaconda3/bin/python",
                        "venv": "/Users/qwer/Documents/code/Transpect/.venv-frida-arm64/bin/python",
                    }
                ),
                encoding="utf-8",
            )
            ...
            self.assertNotIn("/Users/qwer", text)
                ...
                json.dumps(
                    {
                        "showcases": [
                            {
                                "id": "demo",
                                "runDir": "state/showcase/demo",
                                "finalJudgmentPath": "state/showcase/demo/security-reasoning/final_judgment.json",
                            }
                        ]
                    }
                ),
