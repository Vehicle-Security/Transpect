...
from app.instrumentation.frida.event_models import FridaEvent, FridaStartResult, FridaTarget
from app.instrumentation.frida.event_normalizer import FridaEventNormalizer
from app.instrumentation.frida.event_writer import FridaEventWriter
from app.instrumentation.frida.frida_manager import FridaTraceManager
from app.runtime.agent_scenarios.report_builder import build_report
from app.runtime.agent_scenarios.schema import load_scenario
from app.runtime.agent_scenarios.timeline_builder import TimelineBuilder
from app.runtime.agent_scenarios.trace_collector import TraceCollector
from app.security.browser_event_normalizer import BrowserEventNormalizer
from app.security.security_chain_analyzer import SecurityChainAnalyzer
...
class TestFridaUnavailable(unittest.TestCase):
    ...
    def test_manager_reports_unavailable_gracefully(self) -> None:
        from app.instrumentation.frida.frida_resolver import FridaResolution
        mock_res = FridaResolution(package_available=False, attach_ready=False, warnings=["frida_import_failed"])
        with patch("app.instrumentation.frida.frida_resolver.FridaResolver.resolve", return_value=mock_res):
