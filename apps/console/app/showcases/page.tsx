    ...
    <AppShell>
      <div className="mb-6">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
          These reports are replayable product demos generated from state/showcase. No live Agent execution is required.
        </p>
      </div>
      {reports.length === 0 ? (
        <div className="panel p-8">
          <h2 className="text-lg font-semibold text-slate-950">No frozen showcase reports found</h2>
          <p className="mt-2 text-sm text-slate-600">Run python scripts/demo/build_showcase_reports.py after freezing a showcase run.</p>
        </div>
      ) : (
