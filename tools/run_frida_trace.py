...
Usage examples:
    ...
    python tools/run_frida_trace.py --target auto --duration 30 --output monitor/live/frida/frida-smoke.jsonl

    # Trace a specific Node process
    python tools/run_frida_trace.py --target node --duration 60

    # Trace by PID
    python tools/run_frida_trace.py --target pid:12345 --duration 30
"""
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--output", default="monitor/live/frida/frida-smoke.jsonl", help="Output JSONL path.")
    ...
    from monitor.instrumentation.frida.frida_resolver import FridaResolver
