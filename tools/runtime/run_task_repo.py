...
from guardrail.agent_defense.final_judge import run_final_judgment
from guardrail.agent_defense.trace_merge import merge_run_traces
from monitor.instrumentation.frida import FridaTraceConfig, FridaTraceManager
from guardrail.security.context_state import create_security_context
from guardrail.security.intent_guard import inspect_user_input
...
def main() -> None:
    ...
    parser.add_argument("--repo", required=True, help="Task repository slug under monitor/task_repos/.")
    parser.add_argument(
        "--mode",
