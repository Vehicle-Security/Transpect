    ...
    *,
    ...
    if not isinstance(index, dict):
        return {
            ...
            "nextStep": "Generate one with tools/demo/freeze_showcase_run.py --run-dir monitor/live/runs/<runId> --id staged_attack_block --title \"Cross-step Waterhole Attack\" --description \"...\"",
        }
