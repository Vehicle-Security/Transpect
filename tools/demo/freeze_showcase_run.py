...
DEFAULT_SHOWCASE_ROOT = WORKSPACE_ROOT / "dashboard" / "state" / "showcase"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Freeze a live Transpect run into dashboard/state/showcase for product playback.")
    parser.add_argument("--run-dir", required=True, help="Source monitor/live/runs/<runId> directory.")
