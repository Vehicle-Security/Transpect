...
def main() -> None:
    ...
    parser.add_argument("--run-dir", required=True, help="Path to monitor/live/runs/<runId>.")
    parser.add_argument("--no-index", action="store_true", help="Do not rebuild monitor/live/runs/index.json after writing the report.")
