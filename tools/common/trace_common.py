...
def resolve_workspace_root() -> Path:
    ...
    if current.parent.name == "common" and current.parent.parent.name == "tools":
...
TRACE_VIEWER_DIR = TRACE_DASHBOARD_DIR / "viewer"
TRACE_DASHBOARD_STATE_DIR = TRACE_DASHBOARD_DIR / "state"
TRACE_MONITOR_DIR = TRACE_ROOT / "monitor"
TRACE_CONFIG_DIR = TRACE_ROOT / "config"
TRACE_CAPTURES_DIR = TRACE_MONITOR_DIR / "captures"
TRACE_FIXTURE_DIR = TRACE_MONITOR_DIR / "tests" / "fixtures"
TRACE_FRIDA_DIR = TRACE_ROOT / "monitor" / "instrumentation" / "frida" / "scripts"
TRACE_LIVE_DIR = TRACE_MONITOR_DIR / "live"
...
TRACE_TOOLS_DIR = TRACE_ROOT / "tools"
TRACE_SCRIPTS_DIR = TRACE_TOOLS_DIR  # Backward-compatible constant name.
TRACE_VENDOR_DIR = TRACE_MONITOR_DIR / "vendor"
TRACE_BIN_DIR = TRACE_MONITOR_DIR / "bin"
...
def find_openclaw_cmd() -> str | None:
    try:
        from monitor.runtime.agent_scenarios.openclaw_resolver import OpenClawResolver
...
def run_openclaw_agent(
    *,
    ...
    try:
        ...
        # let the caller poll monitor/live/runs/<sessionId>/.
